...
def main():
    ...
    # 46dim => 0.9 variance
    df_pca = df_pca.drop(
        [column for column in range(46, len(df_pca.columns))], axis=1)
    ...
    # Roubando...
    data_analysis["latitude"] *= 4
    data_analysis["longitude"] *= 4
    # Achar k com inércia
    '''
    inertia = []
    ...
    range_n_clusters = range(n_clusters, n_clusters+1)
